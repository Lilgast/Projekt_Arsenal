...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM tblclients WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblclients set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
<head>
    ...
    <title>Online Arsenal Management System | Password Recovery </title>
