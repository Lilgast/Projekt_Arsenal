...
<head>
    ...
    <title>Online Arsenal Management System | Student History</title>
...
$sql = "SELECT tblclients.StudentId ,tblclients.FullName,tblclients.EmailId,tblclients.MobileNumber,tblGuns.BookName,tblGuns.ISBNNumber,issuedgundetails.IssuesDate,issuedgundetails.ReturnDate,issuedgundetails.id as rid,issuedgundetails.fine,issuedgundetails.RetrunStatus,tblGuns.id as bid,tblGuns.bookImage from  issuedgundetails join tblclients on tblclients.StudentId=issuedgundetails.StudentId join tblGuns on tblGuns.id=issuedgundetails.BookId where tblclients.StudentId='$sid' ";
$query = $dbh -> prepare($sql);
$query->execute();
