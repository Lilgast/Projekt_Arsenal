...
{
$id=$_GET['del'];
$sql = "delete from tblManufacturer  WHERE id=:id";
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                          ...
                                          <a href="manage-manufacturers.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
