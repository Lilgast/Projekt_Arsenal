...
if(!empty($_POST["bookid"])) 
  $bookid=$_POST["bookid"];
    ...
    $sql ="SELECT distinct tblGuns.BookName,tblGuns.id,tblManufacturer.AuthorName,tblGuns.bookImage,tblGuns.isIssued FROM tblGuns
join tblManufacturer on tblManufacturer.id=tblGuns.AuthorId
