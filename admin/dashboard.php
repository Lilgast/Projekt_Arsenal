...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Online Arsenal Management System | Admin Dash Board</title>
...
<?php 
$sql2 ="SELECT id from issuedgundetails where (RetrunStatus='' || RetrunStatus is null)";
...
?>
  ...
  <a href="reg-client.php">
               <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-danger back-widget-set text-center">
                            <i class="fa fa-users fa-5x"></i>
                            <?php 
$sql3 ="SELECT id from tblclients ";
...
<?php 
$sq4 ="SELECT id from tblManufacturer ";
