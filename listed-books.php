...
<head>
    ...
    <title>Online Arsenal Management System |  Issued Books</title>
...
<?php $sql = "SELECT tblGuns.BookName,tblcategory.CategoryName,tblManufacturer.AuthorName,tblGuns.ISBNNumber,tblGuns.BookPrice,tblGuns.id as bookid,tblGuns.bookImage,tblGuns.isIssued from  tblGuns join tblcategory on tblcategory.id=tblGuns.CatId join tblManufacturer on tblManufacturer.id=tblGuns.AuthorId";
